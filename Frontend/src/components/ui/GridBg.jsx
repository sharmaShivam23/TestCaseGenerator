...
export const Example = () => (
  <AnimatedGridBackgroundSection>
   <p className="md:text-5xl text-4xl text-center" style={{
            fontFamily: "'Orbitron', sans-serif",
            WebkitBackgroundClip: "text",
            textShadow:
              "0 0 15px rgba(168,85,247,0.7), 0 0 30px rgba(99,102,241,0.5)",
          }}>Discover GitTestPULSe</p> 
          <p className="text-center mt-4 text-sm md:text-lg">Unlock the power of automated test case generation with GITTESTPULSe. Seamlessly integrate your GitHub repositories and generate comprehensive test summaries with ease.</p>
